...
webservice_name = 'demo-turbofan-rul'
...
run = [x for x in ws.experiments['demo-turbofan'].get_runs()][0]

print(run)

model = run.register_model(model_name = "demo-model", model_path = "outputs/model.pkl")
